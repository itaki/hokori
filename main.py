...
if use_gui:
    screen, gui_buttons, gate_buttons = gui.init_pygame(tm, gm)
...
if __name__ == '__main__':
    while run:
        if use_gui:
            gui.draw_gui(screen, gui_buttons, gate_buttons, gm, tm)
            run = gui.handle_events(gui_buttons, gate_buttons, tm, gm)
